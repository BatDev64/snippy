        ...
        variants: {
            variant: {
                default: [
                    ...
                    'dark:hover:bg-neutral-800 dark:active:bg-neutral-950',
                    'dark:focus-visible:ring-neutral-400',
                ],
                primary: [
                    'bg-lime-400 text-black border-transparent',
                    'hover:bg-lime-500 active:bg-lime-600',
                    'focus-visible:ring-lime-400',
                    'dark:bg-lime-500 dark:text-black',
                    'dark:hover:bg-lime-600 dark:active:bg-lime-700',
                    'dark:focus-visible:ring-lime-400',
                ],
                destructive: [
                    ...
                    'dark:hover:bg-red-800 dark:active:bg-red-900',
                ...
                success: [
                    ...
                    'focus-visible:ring-lime-400',
                    'dark:bg-lime-700 dark:text-white',
                    'dark:hover:bg-lime-800 dark:active:bg-lime-900',
                    'dark:focus-visible:ring-lime-400',
                ],
            },
            size: {
